...
$public_file = __DIR__ . '/data/chatflow.json';
$src_file = dirname(__DIR__) . '/src/data/chatflow.json';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($data !== null) {
        ...
        if ($src_success && $public_success) {
            ...
            echo json_encode(["success" => true, "message" => "Chatflow saved successfully"]);
        } else {
            http_response_code(500);
            echo json_encode(["success" => false, "message" => "Failed to save chatflow"]);
        }
    } else {
