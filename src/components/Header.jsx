        ...
        <header className="flex flex-wrap items-center justify-between px-4 md:px-10 py-4 bg-slate-900 border-b border-slate-800 sticky top-0 z-50">
            ...
            <div className="flex items-center gap-2">
                <Link to="/" className="flex items-center gap-2 text-gray-900">
                    <img src="/beautiful_india_logo_1773142903437.png" alt="The Beautiful India" className="h-12 w-auto object-contain drop-shadow-sm hover:opacity-90 transition-opacity" />
                </Link>
            </div>
