 ...
 * Group: tours | Path: /tours/filter/2
 */
const ToursDiscoveryFiltering2 = () => {
  ...
  return (
    <div data-page="tours_discovery_filtering_2">
      <main>
...
<input className="hidden" id="chat-toggle" type="checkbox"/>
<div className="hidden flex-col w-[350px] h-[500px] bg-white rounded-2xl shadow-2xl overflow-hidden border border-neutral-100 mb-4" id="chat-window">
<div className="bg-sunset p-6 flex items-center gap-4">
...
<button className="w-full text-left px-4 py-2.5 bg-white border border-primary/20 text-primary text-xs font-bold rounded-lg hover:bg-primary hover:text-white transition-all">Refund Policy</button>
<button className="w-full text-left px-4 py-2.5 bg-white border border-primary/20 text-primary text-xs font-bold rounded-lg hover:bg-primary hover:text-white transition-all">Talk to Agent</button>
</div>
</div>
<div className="p-4 border-t border-neutral-100 bg-white">
<div className="flex items-center gap-2 bg-sand rounded-xl px-4 py-2">
<input className="w-full bg-transparent border-none focus:ring-0 text-sm placeholder:text-neutral-400 font-medium" placeholder="Type a message..." type="text"/>
...
<label className="w-14 h-14 bg-primary rounded-full shadow-xl flex items-center justify-center text-white cursor-pointer hover:scale-105 transition-all active:scale-95" htmlFor="chat-toggle" id="chat-button">
<span className="material-symbols-outlined text-2xl chat-icon">chat</span>
<span className="material-symbols-outlined text-2xl close-icon">close</span>
</label>
</div>
    </div>
  );
...
export default ToursDiscoveryFiltering2;
