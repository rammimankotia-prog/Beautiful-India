...
<h3 className="text-slate-900 text-lg font-bold leading-tight tracking-tight mb-6 font-display">What to Expect</h3>
...
<div className="w-0.5 bg-slate-200 h-10 my-1"></div>
</div>
<div className="flex flex-col pb-6">
<p className="text-slate-900 text-base font-semibold">Consultation</p>
<p className="text-slate-500 text-sm">A quick call to discuss your travel preferences and budget.</p>
</div>
{/* Step 2 */}
<div className="flex flex-col items-center">
<div className="flex items-center justify-center size-10 rounded-full bg-primary text-white">
...
<div className="flex flex-col pb-6">
<p className="text-slate-900 text-base font-semibold">Itinerary Review</p>
<p className="text-slate-500 text-sm">Customized day-by-day plan delivered to your inbox for feedback.</p>
</div>
{/* Step 3 */}
<div className="flex flex-col items-center">
<div className="flex items-center justify-center size-10 rounded-full bg-primary text-white">
...
<p className="text-slate-900 text-base font-semibold">Booking</p>
<p className="text-slate-500 text-sm">Secure your spot with a deposit and get ready for your adventure.</p>
</div>
</div>
</div>
{/* Action Buttons */}
<div className="flex flex-col sm:flex-row gap-4 w-full">
<button className="flex-1 bg-deep-teal hover:bg-opacity-90 text-white font-bold py-4 px-6 rounded-lg transition-all flex items-center justify-center gap-2">
<span className="material-symbols-outlined">explore</span>
                                Browse More Tours
                            </button>
<button className="flex-1 bg-white border-2 border-slate-200 hover:border-primary text-slate-700 font-bold py-4 px-6 rounded-lg transition-all">
                                View My Dashboard
                            </button>
</div>
</div>
...
{/* Suggested Destination Preview */}
<div className="mt-10">
<h4 className="text-slate-900 font-bold mb-4 font-display">Recommended for your Pro plan</h4>
