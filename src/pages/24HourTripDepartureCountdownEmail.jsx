...
const TripDepartureCountdownEmail = () => {
    return (
...
<h2 className="text-slate-900 dark:text-slate-100 text-xl font-bold tracking-tight">Beautiful India</h2>
</div>
...
<p className="text-accent-teal font-bold mb-8">The Beautiful India Team</p>
<div className="text-xs text-slate-500 space-y-2">
<p>© 2024 Beautiful India. All rights reserved.</p>
...
export default TripDepartureCountdownEmail;
