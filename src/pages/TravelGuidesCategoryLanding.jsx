      ...
      <main style={{ padding: '1.5rem 1rem 3rem', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: '2.5rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          <aside style={{ width: '100%', maxWidth: '320px', flexShrink: 0 }}>
            ...
            {/* Trending Tags */}
            <div className="sidebar-widget" style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.04)', borderRadius: '32px', boxShadow: '0 10px 30px rgba(0,0,0,0.03)' }}>
              <div className="sidebar-widget-header" style={{ fontSize: '1.25rem' }}>
            ...
            {/* Newsletter */}
            <div className="newsletter-widget" style={{ marginBottom: '30px' }}>
              ...
              <form onSubmit={e => { e.preventDefault(); alert('✨ Welcome to the Club! Check your inbox soon.'); }}>
            ...
            {/* Follow Us Widget */}
            <div className="sidebar-widget" style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.04)', borderRadius: '32px', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', padding: '24px' }}>
              <div className="sidebar-widget-header" style={{ fontSize: '1.25rem' }}>
                <span className="material-symbols-outlined sidebar-widget-icon">public</span>
                Follow Our Journey
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
                <a href="https://www.facebook.com/honeymoon.package/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px', borderRadius: '12px', background: '#3b5998', color: '#fff', textDecoration: 'none', fontSize: '12px', fontWeight: 'bold' }}>
                  <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
                  Honeymoon
                </a>
                <a href="https://www.facebook.com/TouristDestinationsofIndia" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px', borderRadius: '12px', background: '#3b5998', color: '#fff', textDecoration: 'none', fontSize: '12px', fontWeight: 'bold' }}>
                  <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
                  Destinations
                </a>
                <a href="https://www.instagram.com/holidaydestinations9/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px', borderRadius: '12px', background: 'linear-gradient(to tr, #f9ce34, #ee2a7b, #6228d7)', color: '#fff', textDecoration: 'none', fontSize: '12px', fontWeight: 'bold' }}>
                ...
                <a href="https://www.reddit.com/r/holidaydestination/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px', borderRadius: '12px', background: '#ff4500', color: '#fff', textDecoration: 'none', fontSize: '12px', fontWeight: 'bold' }}>
                ...
                <a href="https://www.plurk.com/HolidayDestinations" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px', borderRadius: '12px', background: '#cf4732', color: '#fff', textDecoration: 'none', fontSize: '12px', fontWeight: 'bold', gridColumn: 'span 2' }}>
